...
1. Create new project by using composer *"composer create-project jameslevi/voyager=v1.0.4 ."* command and wait for composer to download and install your fresh voyager project.
